...
import {
  ...
  AlertCircle, Search, Stethoscope, ChevronLeft
} from 'lucide-react';
...
function BookingWizard({ onClose, onDone }) {
      ...
      <div className="glass-card w-full max-w-lg p-6 animate-fade-in">
        ...
        <div className="mb-6 flex items-center justify-between">
          <div>
            ...
            <p className="mt-0.5 text-xs text-zinc-500">Step {step} of 4</p>
          </div>
    ...
    <div className="animate-fade-in space-y-8">
      {showBooking && (
        <BookingWizard
          ...
          onDone={() => {
            ...
            fetchAppointments();
            setSuccess('Appointment booked! Your doctor will confirm shortly.');
      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-zinc-400">Manage and schedule your visits.</p>
        </div>
